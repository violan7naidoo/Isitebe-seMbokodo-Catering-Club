-- Setup Banking and Payment System (Safe Version)
...
-- Verify the setup
SELECT 'banking_details table created successfully' as status;
SELECT 'payments table updated with PayFast fields' as status;
SELECT 'RLS policies created for banking_details' as status;
